<div class="form-group state-field">
    ...
    <?php if(!empty($content['options']) && is_array($content['options'])): ?>
      <select name="<?= $key ?? null; ?>" class="form-control administrative-area" id="<?= $key ?? null; ?>">
    ...
    <?php else: ?>
      <input type="text" name="<?= $key ?? null; ?>" id="<?= $key ?? null; ?>" class="form-control administrative-area">
    <?php endif; ?>
</div>
