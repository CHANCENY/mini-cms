...
class Number implements ColumnInterface
{
    ...
    {
        if(!empty($this->column_settings['type']) && !empty($this->column_settings['name']) && !empty($this->column_settings['size'])) {
            $query_line = "ALTER TABLE {$this->parent->getMainTable()} ADD COLUMN {$this->column_settings['name']} INT({$this->column_settings['size']}) ";
            ...
            if(!empty($this->column_settings['primary'])) {
                $query_line .= " ". $this->column_settings['primary'];
            }

            if(!empty($this->column_settings['unique'])) {
                $query_line .= " ".$this->column_settings['unique'];
            }

            if(!empty($this->column_settings['auto_increment'])) {
                $query_line .= " ". $this->column_settings['auto_increment'];
            }
