...
class PhoneFieldMarkUp implements FieldMarkUpInterface
{
    ...
    public function buildMarkup(FieldInterface $field, ?array $default_value): FieldMarkUpInterface
    {
        ...
        $this->markup = <<<FIELD_MARKUP
               ...
               <input type="tel" name="{$this->field->getName()}" id="field-{$this->field->getName()}" class="form-control input-field-text"
